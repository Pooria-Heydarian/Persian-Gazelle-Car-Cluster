...
ECOViewBase::ECOViewBase()
{
    ...
    image1.setXY(77, 131);
    image1.setBitmap(touchgfx::Bitmap(BITMAP_ASSET_42_ID));
    add(image1);

    animatedImage1.setXY(267, 138);
    ...
    animatedImage1_1.setXY(489, 138);
    ...
    scalableImage1.setBitmap(touchgfx::Bitmap(BITMAP_ASSET_40_188_ID));
    ...
    digitalClock1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_L26V));
    ...
    scalableImage2.setBitmap(touchgfx::Bitmap(BITMAP_ASSET_40_188_ID));
    scalableImage2.setPosition(130, 138, 188, 188);
    scalableImage2.setScalingAlgorithm(touchgfx::ScalableImage::NEAREST_NEIGHBOR);
    scalableImage2.setAlpha(126);
    add(scalableImage2);

    scalableImage2_1.setBitmap(touchgfx::Bitmap(BITMAP_ASSET_40_188_ID));
    ...
    gauge1_1.setBackground(touchgfx::Bitmap(BITMAP_ASSET_43_R_ID));
    ...
    textArea2.setXY(207, 248);
    textArea2.setColor(touchgfx::Color::getColorFromRGB(12, 141, 12));
    textArea2.setLinespacing(0);
    textArea2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_T1XU));
    textArea2.setAlpha(239);
    add(textArea2);
    ...
    textProgress1_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_KLI6));
    textProgress1_1.setBackground(touchgfx::Bitmap(BITMAP_TRANSPARENCY500_ID));
    textProgress1_1.setValue(75);
    add(textProgress1_1);

    textProgress1_1_1.setXY(115, 198);
    ...
    textProgress1_1_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_RBK2));
    textProgress1_1_1.setBackground(touchgfx::Bitmap(BITMAP_TRANSPARENCY500_ID));
    textProgress1_1_1.setValue(36);
    add(textProgress1_1_1);

    textArea2_1.setXY(573, 248);
    textArea2_1.setColor(touchgfx::Color::getColorFromRGB(12, 141, 12));
    textArea2_1.setLinespacing(0);
    textArea2_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_PTIC));
    textArea2_1.setAlpha(239);
    add(textArea2_1);

    textArea1_2.setXY(150, 325);
    textArea1_2.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea1_2.setLinespacing(0);
    textArea1_2.setTypedText(touchgfx::TypedText(T___SINGLEUSE_UXFU));
    add(textArea1_2);

    textArea1_1_1.setXY(223, 325);
    textArea1_1_1.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea1_1_1.setLinespacing(0);
    textArea1_1_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_NYRY));
    add(textArea1_1_1);

    textArea1_1.setXY(632, 325);
    textArea1_1.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea1_1.setLinespacing(0);
    textArea1_1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_U28R));
    add(textArea1_1);

    textArea1.setXY(559, 325);
    textArea1.setColor(touchgfx::Color::getColorFromRGB(255, 255, 255));
    textArea1.setLinespacing(0);
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_EIUB));
    add(textArea1);
}
